...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student("Tony Stark", "A123", 3.8));
        students.add(new Student("Peter Parker", "B456", 3.5));
        students.add(new Student("Thor", "C789", 3.9));
        students.add(new Student("Docter Stranger", "D101", 3.2));
        students.add(new Student("Swami", "E202", 4.0));
